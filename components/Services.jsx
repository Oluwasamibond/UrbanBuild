...
const serviceData = [
  {
    ...
    thumbs: [
      { url: "/assets/img/thumb-1.jpg" },
      { url: "/assets/img/thumb-2.jpg" },
    ],
  },
  {
    name: "renovation",
    ...
    description:
      "Revitalizing spaces with modern designs and high-quality craftsmanship. Wheather upgrading a home or remodeling an office, we bring fresh life to every project.",
    serviceList: [
      "Kitchen Remodel",
      "Basement Finish",
      "Flooring",
    ...
    thumbs: [
      { url: "/assets/img/thumb-3.jpg" },
      { url: "/assets/img/thumb-4.jpg" },
    ],
  },
  {
    name: "restoration",
    ...
    thumbs: [
      { url: "/assets/img/thumb-5.jpg" },
      { url: "/assets/img/thumb-6.jpg" },
    ],
  },
  {
    name: "consulting",
    ...
    <section className="pt-16 xl:pt-32" id="services">
      <div className="container mx-auto">
        ...
        >
          ...
          <h2 className="text-[36px] mb-3 xl:text-[46px] xl:leading-[56px] capitalize font-bold leading-[1.3]">
        ...
        >
          ...
          h-full w-full rounded-none p-0 bg-transparent xl:w-[345px]"
            >
              {serviceData.map((item) => {
                return (
                  <TabsTrigger
                    ...
                    value={item.name}
                    className="w-full
                rounded-none h-[100px] flex items-center relative shadow-custom p-0 outline-none"
                  >
                    <div
                    ...
                    <div
                      className="uppercase font-primary text-base font-semibold tracking-[.6px]
                  w-[100px] ml-16"
                    >
                      {item.name}
                    </div>
                  ...
                  >
                    ...
                    <div className="flex md:flex-col gap-5 xl:gap-[30px]">
                      {item.thumbs.map((thumb, index) => (
                        ...
                        >
                          <Image src={thumb.url} fill alt="thumb-img" />
                        </div>
                      ))}
                    </div>
                    ...
                    <div>
                      <div className="">
                        <h3 className="font-primary font-bold text-3xl mb-6">
                          {item.title}
                        </h3>
