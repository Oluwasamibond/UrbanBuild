      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden xl:flex items-center gap-12">
            <ul className="flex">
              {links.map((links, index) => {
                return (
                  ...
                  tracking-[1.2px] after:content-['/'] after:mx-4 last:after:content-none
                  after:text-[#ffca3b]"
                  >
                    <ScrollLink
                      to={links.path}
            ...
            {/* button */}
            <button
              className="w-[200px] h-[54px] py-[5px] pl-[10px] pr-[5px] flex items-center 
          justify-between min-w-[200px] bg-white group"
            >
              <div
                className="flex-1 text-center tracking-[1.2px] font-primary font-bold 
