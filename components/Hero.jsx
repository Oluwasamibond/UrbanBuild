...
const Hero = () => {
  return (
    <section className="h-[70vh] bg-[url('/assets/img/bg.jpg')] bg-no-repeat bg-cover bg-center relative">
      {/* overlay */}
      <div
      ...
      <div className="container mx-auto h-full flex items-center">
        ...
        >
          <motion.h1
            ...
            className="text-[40px] text-white mb-4 xl:text-[54px] uppercase font-black leading-[1.1]"
          >
